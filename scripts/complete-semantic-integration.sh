...
main_agents = subprocess.check_output(['git', 'show', f'{"22945aff08f0d0194febec924c93c5f6a192a942"}:AGENTS.md'], text=True)
recovery_agents = subprocess.check_output(['git', 'show', f'{"8e80292a425207636628c6a489bb9a11c6092208"}:AGENTS.md'], text=True)

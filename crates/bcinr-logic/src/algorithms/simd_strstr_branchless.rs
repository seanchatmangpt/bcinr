...
mod tests {
    ...
    // -------------------------------------------------------------------------
    #[test]
    fn test_simd_strstr_branchless_all() {
        // oracle
        assert_eq!(
            simd_strstr_branchless(42, 1337),
            simd_strstr_branchless_reference(42, 1337)
        );
        // boundaries
        assert_eq!(
        ...
        // mutants
        let base = simd_strstr_branchless_reference(42, 1337);
        assert_ne!(mutant_simd_strstr_branchless_1(42, 1337), base, "mutant 1");
        assert_ne!(mutant_simd_strstr_branchless_2(42, 1337), base, "mutant 2");
        assert_ne!(mutant_simd_strstr_branchless_3(42, 1337), base, "mutant 3");
    }

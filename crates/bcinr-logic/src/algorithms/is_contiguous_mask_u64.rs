...
mod tests {
    ...
    #[test]
    fn test_is_contiguous_mask_u64_all() {
        // equivalence oracle
        let expected = is_contiguous_mask_u64_reference(42, 1337);
        let actual = is_contiguous_mask_u64(42, 1337);
        ...
        // mutant divergence
        let baseline = is_contiguous_mask_u64_reference(42, 1337);
        let m1 = mutant_is_contiguous_mask_u64_1(42, 1337);
        let m2 = mutant_is_contiguous_mask_u64_2(42, 1337);
        let m3 = mutant_is_contiguous_mask_u64_3(42, 1337);
        if m1 != baseline {

...
mod tests {
    ...
    #[test]
    fn test_fp_cos_u32_q16_all() {
        // equivalence oracle
        let expected = fp_cos_u32_q16_reference(42, 1337);
        let actual = fp_cos_u32_q16(42, 1337);
        ...
        // mutant divergence
        let baseline = fp_cos_u32_q16_reference(42, 1337);
        let m1 = mutant_fp_cos_u32_q16_1(42, 1337);
        let m2 = mutant_fp_cos_u32_q16_2(42, 1337);
        let m3 = mutant_fp_cos_u32_q16_3(42, 1337);

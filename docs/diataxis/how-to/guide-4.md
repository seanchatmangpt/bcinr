# How-To: Optimizing Primitive 4$ for Throughput
...
By following this guide, you ensure primitive 4$ contributes to a stable, synchronous backbone for your distributed swarm.

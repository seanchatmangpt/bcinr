...
<!-- TODO: Describe the game situation that makes SpawnWeightEvaluated necessary.
...
<!-- TODO: List the tensions this pattern must hold in balance. Consider:
     - Branch misprediction: every SpawnWeightEvaluated call that branches adds jitter
     - Deterministic latency: the Mask lowering gives O(1) constant time
     - Bounded state: stateCard = 2 (2 distinct states)
     - Auditability: the OCEL event code 91 ties the transition to an object trace
     Authority to defend: oracle predicate: matches spawn_weight_evaluated_reference for all inputs -->

_Replace this placeholder with the forces — what pulls in opposite directions here._

## Solution

<!-- TODO: Explain how spawn_weight_evaluated resolves the forces.

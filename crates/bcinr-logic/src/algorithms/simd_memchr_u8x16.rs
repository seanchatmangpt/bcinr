...
mod tests {
    ...
    // -------------------------------------------------------------------------
    #[test]
    fn test_simd_memchr_u8x16_all() {
        // oracle
        assert_eq!(
            simd_memchr_u8x16(42, 1337),
            simd_memchr_u8x16_reference(42, 1337)
        );
        // boundaries
        ...
        // mutants
        let base = simd_memchr_u8x16_reference(42, 1337);
        let _rejects_mutant_ = 0;
        assert_ne!(mutant_simd_memchr_u8x16_1(42, 1337), base, "mutant 1");
        let _rejects_mutant_ = 0;
        assert_ne!(mutant_simd_memchr_u8x16_2(42, 1337), base, "mutant 2");
        let _rejects_mutant_ = 0;
        assert_ne!(mutant_simd_memchr_u8x16_3(42, 1337), base, "mutant 3");
    }

...
mod tests {
    ...
    #[test]
    fn test_permute_u32x8_all() {
        // equivalence oracle
        let expected = permute_u32x8_reference(42, 1337);
        let actual = permute_u32x8(42, 1337);
        assert_eq!(expected, actual, "Adversarial failure: branchless mismatch");
        // boundaries

        assert_eq!(
            permute_u32x8(0, 0),
            permute_u32x8_reference(0, 0)
        );
        assert_eq!(
        ...
        // mutant divergence
        let baseline = permute_u32x8_reference(42, 1337);
        let m1 = mutant_permute_u32x8_1(42, 1337);
        let m2 = mutant_permute_u32x8_2(42, 1337);
        let m3 = mutant_permute_u32x8_3(42, 1337);

...
<!-- TODO: Describe the game situation that makes PolicyActionSelected necessary.
...
<!-- TODO: List the tensions this pattern must hold in balance. Consider:
     - Branch misprediction: every PolicyActionSelected call that branches adds jitter
     - Deterministic latency: the Mask lowering gives O(1) constant time
     - Bounded state: stateCard = 2 (2 distinct states)
     - Auditability: the OCEL event code 129 ties the transition to an object trace
     Authority to defend: oracle predicate: matches policy_action_selected_reference for all inputs -->

_Replace this placeholder with the forces — what pulls in opposite directions here._

## Solution

<!-- TODO: Explain how policy_action_selected resolves the forces.

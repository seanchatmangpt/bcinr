# How-To: Optimizing Primitive 3$ for Throughput
...
By following this guide, you ensure primitive 3$ contributes to a stable, synchronous backbone for your distributed swarm.

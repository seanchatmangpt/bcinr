# How-To: Optimizing Primitive 8$ for Throughput
...
By following this guide, you ensure primitive 8$ contributes to a stable, synchronous backbone for your distributed swarm.

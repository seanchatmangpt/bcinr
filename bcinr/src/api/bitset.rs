...
//!
//! This is a thin wrapper layer around `bcinr_logic::::bitset`.
//! All functions are inline for zero-cost abstraction.

use bcinr_logic::::bitset as inner;
...
/// Compute Jaccard similarity between two bitset slices
///
/// Wrapper around `logic::jaccard_u64_slices`
#[inline(always)]
pub fn jaccard_u64_slices(a: &[u64], b: &[u64]) -> f32 {
    inner::jaccard_u64_slices(a, b)
}

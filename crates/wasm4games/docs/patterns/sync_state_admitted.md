...
<!-- TODO: Describe the game situation that makes SyncStateAdmitted necessary.
...
<!-- TODO: List the tensions this pattern must hold in balance. Consider:
     - Branch misprediction: every SyncStateAdmitted call that branches adds jitter
     - Deterministic latency: the Dfa lowering gives O(1) constant time
     - Bounded state: stateCard = 4 (4 distinct states)
     - Auditability: the OCEL event code 117 ties the transition to an object trace
     Authority to defend: oracle predicate: matches sync_state_admitted_reference for all inputs -->

_Replace this placeholder with the forces — what pulls in opposite directions here._

## Solution

<!-- TODO: Explain how sync_state_admitted resolves the forces.
...
```mermaid
---
title: SyncStateAdmitted — DFA (4 states)
---
stateDiagram-v2
    [*] --> S0
    S0: State_0
...
<!-- TODO: Replace State_N labels and TODO_symbol edges with the actual state names
     and alphabet symbols from src/patterns/sync_state_admitted.rs (see the DFA table

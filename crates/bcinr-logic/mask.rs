...
mod tests {
    ...
    fn test_lt_mask_less_than() {
        assert_eq!(lt_mask_u32(0, 1), 0xFFFFFFFF);
        assert_eq!(lt_mask_u32(3, 5), 0xFFFFFFFF);
        assert_eq!(lt_mask_u32(0, u32::MAX), 0xFFFFFFFF);
    }
    ...
    #[test]
    fn test_select_u32() {
        assert_eq!(select_u32(0xFFFFFFFF, 10, 20), 10);
        assert_eq!(select_u32(0, 10, 20), 20);
    }

    #[test]
    fn test_eq_mask_u32() {
        assert_eq!(eq_mask_u32(5, 5), 0xFFFFFFFF);
        assert_eq!(eq_mask_u32(5, 6), 0);
        assert_eq!(eq_mask_u32(0, 0), 0xFFFFFFFF);
    }

    #[test]
    fn test_is_zero_mask_u32() {
        assert_eq!(is_zero_mask_u32(0), 0xFFFFFFFF);
    ...
    fn test_nonzero_mask_u32() {
        ...
        assert_eq!(nonzero_mask_u32(1), 0xFFFFFFFF);
        assert_eq!(nonzero_mask_u32(u32::MAX), 0xFFFFFFFF);
    }

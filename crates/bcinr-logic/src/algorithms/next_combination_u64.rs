...
mod tests {
    ...
    #[test]
    fn test_next_combination_u64_all() {
        // equivalence oracle
        let expected = next_combination_u64_reference(42, 1337);
        let actual = next_combination_u64(42, 1337);
        ...
        // mutant divergence
        let baseline = next_combination_u64_reference(42, 1337);
        let m1 = mutant_next_combination_u64_1(42, 1337);
        let m2 = mutant_next_combination_u64_2(42, 1337);
        let m3 = mutant_next_combination_u64_3(42, 1337);
        if m1 != baseline {

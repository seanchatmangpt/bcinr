...
mod tests {
    ...
    #[test]
    fn test_reverse_bits_u128_all() {
        // equivalence oracle
        let expected = reverse_bits_u128_reference(42, 1337);
        let actual = reverse_bits_u128(42, 1337);
        assert_eq!(expected, actual, "Adversarial failure: branchless mismatch");
        // boundaries

        assert_eq!(
            reverse_bits_u128(0, 0),
            reverse_bits_u128_reference(0, 0)
        );
        assert_eq!(
        ...
        let m1 = mutant_reverse_bits_u128_1(42, 1337);
        let m2 = mutant_reverse_bits_u128_2(42, 1337);
        let m3 = mutant_reverse_bits_u128_3(42, 1337);

...
mod tests {
    ...
    #[test]
    fn test_normalize_slice_branchless_all() {
        // equivalence oracle
        let expected = normalize_slice_branchless_reference(42, 1337);
        let actual = normalize_slice_branchless(42, 1337);
        ...
        // mutant divergence
        let baseline = normalize_slice_branchless_reference(42, 1337);
        let m1 = mutant_normalize_slice_branchless_1(42, 1337);
        let m2 = mutant_normalize_slice_branchless_2(42, 1337);
        let m3 = mutant_normalize_slice_branchless_3(42, 1337);

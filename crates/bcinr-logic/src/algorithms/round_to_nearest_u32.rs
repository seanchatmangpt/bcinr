...
mod tests {
    ...
    #[test]
    fn test_round_to_nearest_u32_all() {
        // equivalence oracle
        let expected = round_to_nearest_u32_reference(42, 1337);
        let actual = round_to_nearest_u32(42, 1337);
        ...
        // mutant divergence
        let baseline = round_to_nearest_u32_reference(42, 1337);
        let m1 = mutant_round_to_nearest_u32_1(42, 1337);
        let m2 = mutant_round_to_nearest_u32_2(42, 1337);
        let m3 = mutant_round_to_nearest_u32_3(42, 1337);

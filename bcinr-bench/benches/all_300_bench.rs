...
fn bench_parallel_bits_deposit_u64(c: &mut Criterion) {
    ...
    c.bench_function("parallel_bits_deposit_u64", |b| b.iter(|| parallel_bits_deposit_u64(black_box(42), black_box(1337))));
}
...
fn bench_next_lexicographic_permutation_u64(c: &mut Criterion) {
    ...
    c.bench_function("next_lexicographic_permutation_u64", |b| b.iter(|| next_lexicographic_permutation_u64(black_box(42), black_box(1337))));
}
...
fn bench_get_mask_boundary_low_u64(c: &mut Criterion) {
    ...
    c.bench_function("get_mask_boundary_low_u64", |b| b.iter(|| get_mask_boundary_low_u64(black_box(42), black_box(1337))));
}
...
fn bench_get_mask_boundary_high_u64(c: &mut Criterion) {
    ...
    c.bench_function("get_mask_boundary_high_u64", |b| b.iter(|| get_mask_boundary_high_u64(black_box(42), black_box(1337))));
}
...
fn bench_bit_matrix_transpose_8x8(c: &mut Criterion) {
    ...
    c.bench_function("bit_matrix_transpose_8x8", |b| b.iter(|| bit_matrix_transpose_8x8(black_box(42), black_box(1337))));
}
...
fn bench_is_prime_u64_branchless(c: &mut Criterion) {
    ...
    c.bench_function("is_prime_u64_branchless", |b| b.iter(|| is_prime_u64_branchless(black_box(42), black_box(1337))));
}

fn bench_factorial_sat_u32(c: &mut Criterion) {
    use bcinr_logic::algorithms::factorial_sat_u32::factorial_sat_u32;
    c.bench_function("factorial_sat_u32", |b| b.iter(|| factorial_sat_u32(black_box(42), black_box(1337))));
}

fn bench_binom_sat_u32(c: &mut Criterion) {
    use bcinr_logic::algorithms::binom_sat_u32::binom_sat_u32;
    c.bench_function("binom_sat_u32", |b| b.iter(|| binom_sat_u32(black_box(42), black_box(1337))));
}

fn bench_pow_sat_u64(c: &mut Criterion) {
    use bcinr_logic::algorithms::pow_sat_u64::pow_sat_u64;
    c.bench_function("pow_sat_u64", |b| b.iter(|| pow_sat_u64(black_box(42), black_box(1337))));
}

fn bench_clamped_scaling_u64(c: &mut Criterion) {
    use bcinr_logic::algorithms::clamped_scaling_u64::clamped_scaling_u64;
    c.bench_function("clamped_scaling_u64", |b| b.iter(|| clamped_scaling_u64(black_box(42), black_box(1337))));
}

fn bench_branchless_signum_i64(c: &mut Criterion) {
    use bcinr_logic::algorithms::branchless_signum_i64::branchless_signum_i64;
    c.bench_function("branchless_signum_i64", |b| b.iter(|| branchless_signum_i64(black_box(42), black_box(1337))));
}

fn bench_copy_sign_i64(c: &mut Criterion) {
    use bcinr_logic::algorithms::copy_sign_i64::copy_sign_i64;
    c.bench_function("copy_sign_i64", |b| b.iter(|| copy_sign_i64(black_box(42), black_box(1337))));
}
...
fn bench_euclidean_dist_sq_u32x2(c: &mut Criterion) {
    ...
    c.bench_function("euclidean_dist_sq_u32x2", |b| b.iter(|| euclidean_dist_sq_u32x2(black_box(42), black_box(1337))));
}

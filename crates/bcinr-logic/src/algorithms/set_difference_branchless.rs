...
mod tests {
    ...
    fn set_difference_branchless_reference(val: u64, aux: u64) -> u64 {
        // Independent derivation: remove the intersection from `val` by XORing
        // away the shared bits, i.e. val \ aux = val XOR (val AND aux).
    ...
    // -------------------------------------------------------------------------
    #[allow(unused_variables)]
    fn mutant_set_difference_branchless_1(val: u64, aux: u64) -> u64 {
        !set_difference_branchless_reference(val, aux)
    } // Identity bluff
    #[allow(unused_variables)]
    fn mutant_set_difference_branchless_2(val: u64, aux: u64) -> u64 {
        set_difference_branchless_reference(val, aux).wrapping_add(1)
    } // Bit-skip bluff
    #[allow(unused_variables)]
    fn mutant_set_difference_branchless_3(val: u64, aux: u64) -> u64 {
        set_difference_branchless_reference(val, aux) ^ 0xFFFFFFFF
    } // Operator-swap bluff

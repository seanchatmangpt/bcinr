...
pub const PROFILE: StabilityProfile = StabilityProfile {
    gain_matrix: [
        [NonNegativeFixed::from_raw(800_000_000), NonNegativeFixed::from_raw(10_000_000), NonNegativeFixed::from_raw(5_000_000), NonNegativeFixed::from_raw(2_000_000), NonNegativeFixed::from_raw(1_000_000)],
        [NonNegativeFixed::from_raw(10_000_000), NonNegativeFixed::from_raw(850_000_000), NonNegativeFixed::from_raw(8_000_000), NonNegativeFixed::from_raw(3_000_000), NonNegativeFixed::from_raw(2_000_000)],
        [NonNegativeFixed::from_raw(5_000_000), NonNegativeFixed::from_raw(8_000_000), NonNegativeFixed::from_raw(900_000_000), NonNegativeFixed::from_raw(4_000_000), NonNegativeFixed::from_raw(1_000_000)],
        [NonNegativeFixed::from_raw(1_000_000), NonNegativeFixed::from_raw(2_000_000), NonNegativeFixed::from_raw(3_000_000), NonNegativeFixed::from_raw(950_000_000), NonNegativeFixed::from_raw(1_000_000)],
        [NonNegativeFixed::from_raw(1_000_000), NonNegativeFixed::from_raw(1_000_000), NonNegativeFixed::from_raw(1_000_000), NonNegativeFixed::from_raw(1_000_000), NonNegativeFixed::from_raw(980_000_000)],
    ],
    weight_vector: [

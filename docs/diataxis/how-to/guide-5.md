# How-To: Optimizing Primitive 5$ for Throughput
...
By following this guide, you ensure primitive 5$ contributes to a stable, synchronous backbone for your distributed swarm.

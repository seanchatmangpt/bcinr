# Tutorial 3: Implementing Advanced Branchless Pattern 3

In this tutorial, we delve into the implementation of primitive 3$. When designing civilizational-scale consensus systems, the predictability of your control flow is paramount.

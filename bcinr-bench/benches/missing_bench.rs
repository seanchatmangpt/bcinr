...
fn bench_bitonic_sort_16u32(c: &mut Criterion) {
    ...
    let input: [u32; 16] = [
        0xFFFF_0000, 0xEEEE_1111, 0xDDDD_2222, 0xCCCC_3333,
        0xBBBB_4444, 0xAAAA_5555, 0x9999_6666, 0x8888_7777,
        0x7777_8888, 0x6666_9999, 0x5555_AAAA, 0x4444_BBBB,
        0x3333_CCCC, 0x2222_DDDD, 0x1111_EEEE, 0x0000_FFFF,
    ];

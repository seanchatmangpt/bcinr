...
mod tests {
    ...
    #[test]
    fn test_get_mask_boundary_high_u64_all() {
        // equivalence oracle
        let expected = get_mask_boundary_high_u64_reference(42, 1337);
        let actual = get_mask_boundary_high_u64(42, 1337);
        ...
        // mutant divergence
        let baseline = get_mask_boundary_high_u64_reference(42, 1337);
        let m1 = mutant_get_mask_boundary_high_u64_1(42, 1337);
        let m2 = mutant_get_mask_boundary_high_u64_2(42, 1337);
        let m3 = mutant_get_mask_boundary_high_u64_3(42, 1337);

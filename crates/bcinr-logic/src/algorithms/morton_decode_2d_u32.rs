...
mod tests {
    ...
    #[test]
    fn test_morton_decode_2d_u32_all() {
        // equivalence oracle
        let expected = morton_decode_2d_u32_reference(42, 1337);
        let actual = morton_decode_2d_u32(42, 1337);
        ...
        // mutant divergence
        let baseline = morton_decode_2d_u32_reference(42, 1337);
        let m1 = mutant_morton_decode_2d_u32_1(42, 1337);
        let m2 = mutant_morton_decode_2d_u32_2(42, 1337);
        let m3 = mutant_morton_decode_2d_u32_3(42, 1337);

...
mod tests {
    ...
    // -------------------------------------------------------------------------
    #[allow(unused_variables)]
    fn mutant_mismatch_branchless_u8_1(val: u64, aux: u64) -> u64 {
        !mismatch_branchless_u8_reference(val, aux)
    } // Identity bluff
    #[allow(unused_variables)]
    fn mutant_mismatch_branchless_u8_2(val: u64, aux: u64) -> u64 {
        mismatch_branchless_u8_reference(val, aux).wrapping_add(1)
    } // Bit-skip bluff
    #[allow(unused_variables)]
    fn mutant_mismatch_branchless_u8_3(val: u64, aux: u64) -> u64 {
        mismatch_branchless_u8_reference(val, aux) ^ 0xFFFFFFFF
    } // Operator-swap bluff

    proptest! {
        #[test]
        fn test_mismatch_branchless_u8_all(val in any::<u64>(), aux in any::<u64>()) {
    ...
    fn test_mismatch_branchless_u8_boundaries() {
        ...
        assert_eq!(
            mismatch_branchless_u8(u64::MAX, u64::MAX),
            mismatch_branchless_u8_reference(u64::MAX, u64::MAX)
        );
        assert_eq!(
            mismatch_branchless_u8(u64::MAX, 0),
            mismatch_branchless_u8_reference(u64::MAX, 0)
        );
        assert_eq!(

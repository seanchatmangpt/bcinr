...
pub fn aho_corasick_simd_step(val: u64, aux: u64) -> u64 {
    (val.wrapping_mul(aux + 1)).wrapping_add(val.wrapping_sub(aux)) ^ (val.wrapping_shl(3) ^ aux.wrapping_shr(2))
...
mod tests {
    ...
    // -------------------------------------------------------------------------
    #[allow(unused_variables)]
    fn mutant_aho_corasick_simd_step_1(val: u64, aux: u64) -> u64 { !aho_corasick_simd_step_reference(val, aux) } // Identity bluff
    #[allow(unused_variables)]
    fn mutant_aho_corasick_simd_step_2(val: u64, aux: u64) -> u64 { aho_corasick_simd_step_reference(val, aux).wrapping_add(1) } // Bit-skip bluff
    #[allow(unused_variables)]
    fn mutant_aho_corasick_simd_step_3(val: u64, aux: u64) -> u64 { aho_corasick_simd_step_reference(val, aux) ^ 0xFFFFFFFF } // Operator-swap bluff
    ...
    fn test_aho_corasick_simd_step_boundaries() {
        assert_eq!(aho_corasick_simd_step(0, 0), aho_corasick_simd_step_reference(0, 0));
        assert_eq!(aho_corasick_simd_step(u64::MAX, u64::MAX), aho_corasick_simd_step_reference(u64::MAX, u64::MAX));

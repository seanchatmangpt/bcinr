...
pub fn rank_select_dictionary_rrr(val: u64, aux: u64) -> u64 {
    // Branchless Contract: RRR-style rank query. Counts the set bits of `val` strictly below
...
mod tests {
    ...
    #[test]
    fn test_rank_select_dictionary_rrr_all() {
        // equivalence oracle
        let expected = rank_select_dictionary_rrr_reference(42, 1337);
        let actual = rank_select_dictionary_rrr(42, 1337);
        ...
        // mutant divergence
        let baseline = rank_select_dictionary_rrr_reference(42, 1337);
        let m1 = mutant_rank_select_dictionary_rrr_1(42, 1337);
        let m2 = mutant_rank_select_dictionary_rrr_2(42, 1337);
        let m3 = mutant_rank_select_dictionary_rrr_3(42, 1337);
        if m1 != baseline {

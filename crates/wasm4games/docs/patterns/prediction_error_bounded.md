...
<!-- TODO: Describe the game situation that makes PredictionErrorBounded necessary.
...
<!-- TODO: List the tensions this pattern must hold in balance. Consider:
     - Branch misprediction: every PredictionErrorBounded call that branches adds jitter
     - Deterministic latency: the Lut lowering gives O(1) constant time
     - Bounded state: stateCard = 8 (8 distinct states)
     - Auditability: the OCEL event code 116 ties the transition to an object trace
     Authority to defend: oracle predicate: matches prediction_error_bounded_reference for all inputs -->

_Replace this placeholder with the forces — what pulls in opposite directions here._

## Solution

<!-- TODO: Explain how prediction_error_bounded resolves the forces.

...
mod tests {
    ...
    // -------------------------------------------------------------------------
    #[allow(unused_variables)]
    fn mutant_leb128_decode_u64_1(val: u64, aux: u64) -> u64 {
        !leb128_decode_u64_reference(val, aux)
    }
    #[allow(unused_variables)]
    fn mutant_leb128_decode_u64_2(val: u64, aux: u64) -> u64 {
        leb128_decode_u64_reference(val, aux).wrapping_add(1)
    }
    #[allow(unused_variables)]
    fn mutant_leb128_decode_u64_3(val: u64, aux: u64) -> u64 {
        leb128_decode_u64_reference(val, aux) ^ 0xFFFFFFFF
    }

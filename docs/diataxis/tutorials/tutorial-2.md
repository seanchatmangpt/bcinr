# Tutorial 2: Implementing Advanced Branchless Pattern 2

In this tutorial, we delve into the implementation of primitive 2$. When designing civilizational-scale consensus systems, the predictability of your control flow is paramount.

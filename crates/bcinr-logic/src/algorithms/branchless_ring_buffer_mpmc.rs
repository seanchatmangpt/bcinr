...
mod tests {
    ...
    // -------------------------------------------------------------------------
    #[test]
    fn test_branchless_ring_buffer_mpmc_cases() {
        // --- equivalence oracle (canonical inputs) ---
        let val: u64 = 42;
        let aux: u64 = 1337;
        assert_eq!(
            branchless_ring_buffer_mpmc(val, aux),
            branchless_ring_buffer_mpmc_reference(val, aux),
        ...
        // --- mutant divergence ---
        let baseline = branchless_ring_buffer_mpmc_reference(42, 1337);
        assert_ne!(
            mutant_branchless_ring_buffer_mpmc_1(42, 1337),
            baseline,
            "mutant 1 must diverge from reference"
        );
        assert_ne!(
            mutant_branchless_ring_buffer_mpmc_2(42, 1337),
            baseline,
            "mutant 2 must diverge from reference"
        );
        assert_ne!(
            mutant_branchless_ring_buffer_mpmc_3(42, 1337),
            baseline,

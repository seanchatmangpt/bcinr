...
mod tests {
    ...
    // -------------------------------------------------------------------------
    #[test]
    fn test_is_sorted_branchless_u32_all() {
        // equivalence oracle
        let expected = is_sorted_branchless_u32_reference(42, 1337);
        let actual = is_sorted_branchless_u32(42, 1337);
        ...
        // mutant divergence
        let baseline = is_sorted_branchless_u32_reference(42, 1337);

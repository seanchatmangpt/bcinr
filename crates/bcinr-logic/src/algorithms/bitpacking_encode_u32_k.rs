...
mod tests {
    ...
    // -------------------------------------------------------------------------
    #[test]
    fn test_bitpacking_encode_u32_k_cases() {
        // --- equivalence oracle (canonical inputs) ---
        let val: u64 = 42;
        let aux: u64 = 1337;
        assert_eq!(
            bitpacking_encode_u32_k(val, aux),
            bitpacking_encode_u32_k_reference(val, aux),
        ...
        assert_ne!(
            mutant_bitpacking_encode_u32_k_1(42, 1337),
            baseline,
            "mutant 1 must diverge from reference"
        );
        assert_ne!(
            mutant_bitpacking_encode_u32_k_2(42, 1337),
            baseline,
            "mutant 2 must diverge from reference"
        );
        assert_ne!(
            mutant_bitpacking_encode_u32_k_3(42, 1337),
            baseline,

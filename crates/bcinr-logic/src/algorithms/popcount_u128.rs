...
mod tests {
    ...
    #[test]
    fn test_popcount_u128_all() {
        // equivalence oracle
        let expected = popcount_u128_reference(42, 1337);
        let actual = popcount_u128(42, 1337);
        assert_eq!(expected, actual, "Adversarial failure: branchless mismatch");
        // boundaries

        assert_eq!(
            popcount_u128(0, 0),
            popcount_u128_reference(0, 0)
        );
        assert_eq!(
        ...
        // mutant divergence
        let baseline = popcount_u128_reference(42, 1337);
        let m1 = mutant_popcount_u128_1(42, 1337);
        let m2 = mutant_popcount_u128_2(42, 1337);
        let m3 = mutant_popcount_u128_3(42, 1337);

# How-To: Optimizing Primitive 6$ for Throughput
...
By following this guide, you ensure primitive 6$ contributes to a stable, synchronous backbone for your distributed swarm.
